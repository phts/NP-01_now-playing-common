...
import { ContentRegionSettings } from './ContentRegionSettings.js';
...
export type CommonRawSettingsOf<T extends CommonSettingsCategory> = T extends CommonSettingsCategory.Startup ? StartupOptions : T extends CommonSettingsCategory.Theme ? ThemeSettings : T extends CommonSettingsCategory.Performance ? PerformanceSettings : T extends CommonSettingsCategory.Localization ? LocalizationSettings : T extends CommonSettingsCategory.ContentRegion ? ContentRegionSettings : T extends CommonSettingsCategory.Background ? BackgroundSettings : T extends CommonSettingsCategory.ActionPanel ? ActionPanelSettings : T extends CommonSettingsCategory.NowPlayingScreen ? NowPlayingScreenSettings : T extends CommonSettingsCategory.IdleScreen ? IdleScreenSettings : never;
