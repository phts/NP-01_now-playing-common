...
export type NowPlayingMetadataProvider<NowPlayingMetadataProviderVersion = '1.0.0'> =
  NowPlayingMetadataProviderVersion extends '1.1.0' ? NowPlayingMetadataProvider_Current :
  NowPlayingMetadataProviderVersion extends '1.0.0' ? NowPlayingMetadataProvider_1_0_0 :
  never;
